...
static void FillRect(int x, int y, int w, int h, fb_pixel_t color)
{
...
static void FillBorder(fb_pixel_t color)
{
...
static void ClearBB(fb_pixel_t color)
{
...
#if 0 
//never used
static void ClearB(fb_pixel_t color)
{
...
static void DrawVLine(int x, int y, int l, fb_pixel_t color)
{
	fb_pixel_t *p = getFBp(y);
	fb_pixel_t col = argb[color];
	p += x + y * var_screeninfo.xres;
...
static void DrawHLine(int x, int y, int l, fb_pixel_t color)
{
	fb_pixel_t *p = getFBp(y);
	fb_pixel_t col = argb[color];
	p += x + y * var_screeninfo.xres;
...
static void FillTrapez(int x0, int y0, int l0, int xoffset1, int h, int l1, fb_pixel_t color)
{
